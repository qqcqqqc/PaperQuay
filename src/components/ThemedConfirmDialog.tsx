...
export default function ThemedConfirmDialog({
  ...
  const content = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/42 px-4 py-6 backdrop-blur-sm dark:bg-black/56">
      <div className="pq-card w-full max-w-md p-5 shadow-[var(--pq-shadow-dialog)]">
